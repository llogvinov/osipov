...
namespace Windows_Form_Word
{
    public partial class Form1 : Form
    {
        ...
        private void NewDocument()
        {
            ...
            {
                WordObj.Range headerRange =
                section.Headers[WordObj.WdHeaderFooterIndex.wdHeaderFooterPrimary].Range;
                ...
                headerRange.Text = "Это верхний колонтитул:" + Environment.NewLine +
                "Отчет";
            }
            ...
            foreach (WordObj.Section wordSection in document.Sections)
            {
                ...
                WordObj.WdParagraphAlignment.wdAlignParagraphCenter;
                footerRange.Text = "Это нижний колонтитул:" + Environment.NewLine +
                "Отчет";
            }
            ...
            foreach (WordObj.Row row in firstTable.Rows)
            {
                foreach (WordObj.Cell cell in row.Cells)
                {
                    ...
                    {
                        cell.Range.Text = (cell.RowIndex - 2 +
