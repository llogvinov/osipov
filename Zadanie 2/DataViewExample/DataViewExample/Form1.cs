...
namespace DataViewExample
{
    public partial class Form1 : Form
    {
        ...
        {
            customersTableAdapter1.Fill(northwindqDataSet1.Customers);
            ordersTableAdapter1.Fill(northwindqDataSet1.Orders);
            customersDataView = new DataView(northwindqDataSet1.Customers);
            ordersDataView = new DataView(northwindqDataSet1.Orders);
        ...
        private void GetOrdersButton_Click(object sender, EventArgs e)
        {
            ...
            ordersDataView =selectedRow.CreateChildView(northwindqDataSet1.Relations["FK_Orders_Customers"]);
